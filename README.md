# API For Conference Rooms
## Create tables users(user_id, username, phone, email, password, dob) and rooms(room_id, room_name, room_cost, room_desc, availability, image_url)


## Create a Flask Application, and paste the code below on file app.py
...
def register():
    ...
    connection = pymysql.connect(
        host='localhost', user='root', password='', database='ConferenceRoomDB')
    # cursor
...
def register():
    ...
    # database connection
    connection = pymysql.connect(
        host='erickapi.mysql.pythonanywhere-services.com', user='erickapi', password='Modcom#2023', database='erickapi$default')
    # cursor
    cursor = connection.cursor()
...
# db password: Modcom#2023
# host : erickapi.mysql.pythonanywhere-services.com
# user : erickapi
# database : erickapi$default


``
Make sure to change DB connection
